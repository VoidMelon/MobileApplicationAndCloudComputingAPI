...
api.add_resource(EnvironmentResource, '/user/<string:user_id>/sessions/<int:session_id>/environmentdata')
api.add_resource(EnvironmentDatasResource, '/users/<string:user_id>/sessions/<int:session_id>/environmentdatas')
api.add_resource(FriendResource, '/friendlist/<string:user_id>', '/friendlist/remove')
api.add_resource(PendingResource, '/pendinglist/<string:user_id>', '/pendinglist/confirm', '/pendinglist/remove')
api.add_resource(SearchResource, '/search/<string:username>', '/search/sendfriendrequest')
